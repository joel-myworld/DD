...
module.exports = function (grunt) {
	...
	grunt.initConfig({
        dir: {
            ...
            tests: "test",
            dist: "dist",
            localServerTestUrl: "http://localhost:9090/test-resources"
        },
        ...
        connect: {
            ...
            serve: {
                options: {
                    open: {
                        target: "http://localhost:9090/index.html"
                    }
                }
            },
            ...
            dist: {
                options: {
                    open: {
                        target: "http://localhost:9090/build.html",
                        app: 'Google Chrome'
                    }
                }
            }
        ...
        openui5_preload: {
            component: {
                options: {
                    resources: {
                        cwd: "<%= dir.webapp %>",
                        prefix: "com/siemens/datadictionary"
                    },
                    dest: "<%= dir.dist %>"
                },
                components: true,
